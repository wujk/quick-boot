...
public class JsonMapper {
	 ...
	 * 构造Collection类型.
	 */
	public JavaType contructCollectionType(@SuppressWarnings("rawtypes") Class<? extends Collection> class1,
			Class<?> elementClass) {
		return mapper.getTypeFactory().constructCollectionType(class1, elementClass);
	}
	 ...
	 * 构造Map类型.
	 */
	public JavaType contructMapType(@SuppressWarnings("rawtypes") Class<? extends Map> mapClass, JavaType keyClass, JavaType valueClass) {
		return mapper.getTypeFactory().constructMapType(mapClass, keyClass, valueClass);
	}
