...
public class SendCloud {
	 ...
	 * @throws IOException
	 */
	public ResponseData mailCount(SendCloudMailCount sendCloudMailCount)
			throws ClientProtocolException, IOException {
		...
		if(StringUtils.isNotEmpty(sendCloudMailCount.getStartDate()) && StringUtils.isNotEmpty(sendCloudMailCount.getEndDate())) {
			//按每小时统计
